...
(when_cond) @keyword
(always_event) @type
(enter_room ["enter" "room"] @emphasis.strong)
(take_item ["take" "item"] @emphasis.strong)
(drop_item ["drop" "item"] @emphasis.strong)
(unlock_item ["unlock" "item"] @emphasis.strong)
(talk_to_npc ["talk" "to" "npc"] @emphasis.strong)
(open_item ["open" "item"] @emphasis.strong)
(leave_room ["leave" "room"] @emphasis.strong)
(look_at_item ["look" "at" "item"] @emphasis.strong)
(use_item ["use" "item" "ability"] @emphasis.strong)
(give_to_npc ["give" "item" "to" "npc"] @emphasis.strong)
(use_item_on_item
    ["use" "item" "on" "item" "interaction"] @emphasis.strong)
    (act_on_item ["act" "on" "item"] @emphasis.strong)
    (take_from_npc ["take" "item" "from" "npc"] @emphasis.strong)
    (insert_item_into ["insert" "item" "into"] @emphasis.strong)
    (ingest_item ["eat" "drink" "inhale" "item"] @emphasis.strong)
